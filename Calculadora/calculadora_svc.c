...
main (int argc, char **argv)
{
	...
	pmap_unset (Calculadora, Calculadora_VERS);
	...
	if (!svc_register(transp, Calculadora, Calculadora_VERS, calculadora_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (Calculadora, Calculadora_VERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, Calculadora, Calculadora_VERS, calculadora_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (Calculadora, Calculadora_VERS, tcp).");
		exit(1);
	}
